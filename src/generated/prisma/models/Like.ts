...
export type GetLikeGroupByPayload<T extends LikeGroupByArgs> =
    Prisma.PrismaPromise<
        Array<
            Prisma.PickEnumerable<LikeGroupByOutputType, T['by']> & {
                [P in keyof T & keyof LikeGroupByOutputType]: P extends (
                    '_count'
                ) ?
                    T[P] extends boolean ?
                        number
...
export type LikeWhereUniqueInput = Prisma.AtLeast<
    {
        ...
        createdAt?: Prisma.DateTimeFilter<'Like'> | Date | string;
        post?: Prisma.XOR<
            Prisma.PostScalarRelationFilter,
...
> {
    ...
    >(
        args: Prisma.SubsetIntersection<T, LikeGroupByArgs, OrderByArg>
            & InputErrors,
    ): {} extends InputErrors ? GetLikeGroupByPayload<T>
